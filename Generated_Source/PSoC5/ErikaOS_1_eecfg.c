 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_whiteFlash) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_whiteFlash) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_whiteFlash*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_whiteFlash*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_whiteFlash */
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread tsk_whiteFlash */
    #endif
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alarm_1ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alarm_measureTime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alarm_measureTime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, alrm_5000, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 4
        ,{0, Alarm_5, EE_ALARM }
        #endif
