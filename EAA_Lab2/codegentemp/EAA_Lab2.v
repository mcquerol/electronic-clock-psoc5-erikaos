// ======================================================================
// EAA_Lab2.v generated from TopDesign.cysch
// 06/22/2022 at 19:32
...
module ADC_SAR_SEQ_v2_10_5 (
	...
	cy_clock_v1_0
		#(.id("24eb8c8c-c313-4163-9a28-a7b379179316/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("24eb8c8c-c313-4163-9a28-a7b379179316/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_1319),
        .rx_data(Net_1320),
        .rx_interrupt(Net_1321),
        .tx(Net_1027),
        .tx_clk(Net_1322),
        .tx_data(Net_1323),
        .tx_en(Net_1324),
        .tx_interrupt(Net_1325));
	...
	wire [0:0] tmpOE__JS_X_net;
	wire [0:0] tmpFB_0__JS_X_net;
	wire [0:0] tmpIO_0__JS_X_net;
	wire [0:0] tmpINTERRUPT_0__JS_X_net;
	electrical [0:0] tmpSIOVREF__JS_X_net;
	...
	cy_psoc3_pins_v1_10
		...
		JS_X
		 (.oe(tmpOE__JS_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__JS_X_net[0:0]}),
		  .analog({Net_1193}),
		  .io({tmpIO_0__JS_X_net[0:0]}),
		  .siovref(tmpSIOVREF__JS_X_net),
		  .interrupt({tmpINTERRUPT_0__JS_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__JS_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__JS_Y_net;
	wire [0:0] tmpFB_0__JS_Y_net;
	wire [0:0] tmpIO_0__JS_Y_net;
	wire [0:0] tmpINTERRUPT_0__JS_Y_net;
	electrical [0:0] tmpSIOVREF__JS_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("25d406c2-fae3-44a2-b3ea-c9cebedeaf2e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		JS_Y
		 (.oe(tmpOE__JS_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__JS_Y_net[0:0]}),
		  .analog({Net_1291}),
		  .io({tmpIO_0__JS_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__JS_Y_net),
		  .interrupt({tmpINTERRUPT_0__JS_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__JS_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SPI_Master_v2_50_6 TFT_SPI (
        .clock(1'b0),
        .miso(Net_1462),
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_1464),
        .sclk(wTFT_SCL),
        .sdat(Net_1465),
        .ss(Net_1466),
        .tx_interrupt(Net_1467));
    ...
    assign Net_1462 = 1'h0;

    assign Net_1468 = 1'h0;
