...
#define CFG_LOGGING_SENDER_L        60                      /**< \brief Number of Characters, that can be used for the logging message sender */
#define CFG_LOGGING_FR_L            80                      /**< \brief Number of Characters, that can be used additionally for wrapping the information into a readable format  */
