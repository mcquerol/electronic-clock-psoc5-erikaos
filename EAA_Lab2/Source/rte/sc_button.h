 ...
 *
 **/
inline RC_t RTE_SC_BUTTON_init( SC_BUTTON_t * const signal, const SC_BUTTON_data_t * const value )
{                                                                                                                      
 ...
 *
 **/
inline RTE_signalStatus_t RTE_SC_BUTTON_getStatus( const SC_BUTTON_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_BUTTON_setStatus( SC_BUTTON_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_BUTTON_getAge( const SC_BUTTON_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_BUTTON_incAge(  SC_BUTTON_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 **/
inline SC_BUTTON_data_t RTE_SC_BUTTON_get( const SC_BUTTON_t * const signal )
{               
 ...
 *
 **/
inline RC_t RTE_SC_BUTTON_getThreadSafe( const SC_BUTTON_t * const signal, SC_BUTTON_data_t * const data )
{    
 ...
 *
 **/
inline RC_t RTE_SC_BUTTON_set(SC_BUTTON_t * const signal, const SC_BUTTON_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_BUTTON_pullPort( SC_BUTTON_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
 ...
 *
 **/
inline RC_t RTE_SC_BUTTON_pushPort( const SC_BUTTON_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
