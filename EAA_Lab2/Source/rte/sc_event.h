...
/*
* description: Signal Class which will contain the events processed.
* name: sc_event
* shortname: event
*/
 ...
 *
 **/
inline RC_t RTE_SC_EVENT_init( SC_EVENT_t * const signal, const SC_EVENT_data_t * const value )
{                                                                                                                      
 ...
 *
 **/
inline RTE_signalStatus_t RTE_SC_EVENT_getStatus( const SC_EVENT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_EVENT_setStatus( SC_EVENT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_EVENT_getAge( const SC_EVENT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_EVENT_incAge(  SC_EVENT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 **/
inline SC_EVENT_data_t RTE_SC_EVENT_get( const SC_EVENT_t * const signal )
{               
 ...
 *
 **/
inline RC_t RTE_SC_EVENT_getThreadSafe( const SC_EVENT_t * const signal, SC_EVENT_data_t * const data )
{    
 ...
 *
 **/
inline RC_t RTE_SC_EVENT_set(SC_EVENT_t * const signal, const SC_EVENT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_EVENT_pullPort( SC_EVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
 ...
 *
 **/
inline RC_t RTE_SC_EVENT_pushPort( const SC_EVENT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
