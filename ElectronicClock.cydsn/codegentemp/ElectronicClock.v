// ======================================================================
// ElectronicClock.v generated from TopDesign.cysch
// 04/02/2023 at 19:22
...
module ADC_SAR_SEQ_v2_10_5 (
	...
	cy_clock_v1_0
		#(.id("6d7e01e4-80ac-4eec-aea8-6914c141aa21/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("6d7e01e4-80ac-4eec-aea8-6914c141aa21/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_2062),
        .rx_data(Net_2063),
        .rx_interrupt(Net_2064),
        .tx(Net_2056),
        .tx_clk(Net_2065),
        .tx_data(Net_2066),
        .tx_en(Net_2067),
        .tx_interrupt(Net_2068));
	...
	wire [0:0] tmpOE__BUTTON_JOYSTICK_net;
	wire [0:0] tmpIO_0__BUTTON_JOYSTICK_net;
	wire [0:0] tmpINTERRUPT_0__BUTTON_JOYSTICK_net;
	electrical [0:0] tmpSIOVREF__BUTTON_JOYSTICK_net;

	cy_psoc3_pins_v1_10
		#(.id("59037677-4754-41cc-8eaa-8ea4df3f124f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUTTON_JOYSTICK
		 (.oe(tmpOE__BUTTON_JOYSTICK_net),
		  .y({1'b0}),
		  .fb({Net_2107}),
		  .io({tmpIO_0__BUTTON_JOYSTICK_net[0:0]}),
		  .siovref(tmpSIOVREF__BUTTON_JOYSTICK_net),
		  .interrupt({tmpINTERRUPT_0__BUTTON_JOYSTICK_net[0:0]}),
		  .annotation({Net_2106}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BUTTON_JOYSTICK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4760dc34-0eb6-49f9-b23b-c89fad1d81a2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_2211),
        .sclk(wTFT_SCL),
        .sdat(Net_2212),
        .ss(Net_2213),
        .tx_interrupt(Net_2214));
    ...
    assign Net_2209 = 1'h0;

    assign Net_2215 = 1'h0;
    ...
    assign Net_2221 = 1'h0;

    USBFS_v3_20_8 USBUART (
        .sof(Net_2230),
        .vbusdet(1'b0));
